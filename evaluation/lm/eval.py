...
model_path_template='../../data/models/lm/checkpoints/{model_type}/{name}/{model_type}_lr1e-05'
head_path_template='../../data/models/lm/checkpoints/{model_type}/{name}/{model_type}_lr1e-05/classifier_head.pt'
...
def compute_single_metrics(eval_pred, dataset_name):
    ...
    metric_func = evaluate.load(path="./lmDatasets/glue.py", config_name=dataset_name)
